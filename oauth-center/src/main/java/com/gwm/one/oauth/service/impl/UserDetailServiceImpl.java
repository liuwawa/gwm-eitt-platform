package com.gwm.one.oauth.service.impl;
...
import com.gwm.one.oauth.feign.SmsClient;
...
public class UserDetailServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (loginAppUser == null) {
            throw new AuthenticationCredentialsNotFoundException(ResponseStatus.RESPONSE_ACCOUNT_ERROR.message);
