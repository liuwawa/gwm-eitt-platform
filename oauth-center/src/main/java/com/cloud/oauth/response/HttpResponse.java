...
import static com.cloud.oauth.response.HttpStatusAndMsg.EX_STATUS;
...
public final class HttpResponse {
    ...
    public static BaseResponse baseResponse(int status, String msg) {
        ...
        if (msg != null) {
            ...
            return new BaseResponse(status, EX_STATUS.get(status));
        }
    }
    ...
    public static SimpleResponse simpleResponse(int status, String msg, Object data) {
        ...
        if (msg != null) {
            ...
            response.setMsg(EX_STATUS.get(status));
        }
