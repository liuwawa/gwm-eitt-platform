...
public class CodeGeneration {
    ...
    public static void main(String[] args) {
        ...
        strategy.setTablePrefix(new String[]{"px_"}); // 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel); // 表名生成策略
        strategy.setInclude(new String[]{"px_innerTeacher"}); // 需要生成的表
        ...
        pc.setParent("com.gwm.one.model.hr.personnel"); //包名生成配置 这里只有指定目录才需要更改
