package com.gwm.one.common.db.sync.provider;
...
import com.gwm.one.common.db.sync.provider.entity.DBInfo;
import com.gwm.one.common.db.sync.provider.entity.JobInfo;
import com.gwm.one.common.db.sync.provider.factory.DBSyncFactory;
